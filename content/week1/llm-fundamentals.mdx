...
- Claude 3.5 Sonnet: 200K tokens standard, 1M tokens extended (~750K words)
- GPT-5: 400K tokens
- GPT-4o: 128K tokens
...
| Claude 3.5 Sonnet | Medium | Fast | Excellent | Balanced performance, coding, agents |
...
- Monthly cost (Claude 3.5 Sonnet): (1M × $3 + 2M × $15) / 1M × 30 = $33/day = $990/month
...
// Claude 3.5 Sonnet        2200ms      28             245             $0.003759
...
- **Claude 3.5 Sonnet** for balanced performance (general purpose, coding)
