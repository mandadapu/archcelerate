...
<CodePlayground
  ...
  description="Click 'Run Code' to see Zod schema validation catch invalid inputs"
  exerciseType="input-validation"
  code={`// This example demonstrates input validation with Zod
// Try different test cases to see validation errors
...
// Test various inputs to see what passes and what fails`}
/>
