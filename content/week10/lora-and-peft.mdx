...
## ⚖️ Real-World Challenge: The Legal Language Specialist
...
- Monthly cost: 5,000 contracts × $2.40 = **$12,000/month**
...
console.log(`✅ Curated ${goldenDataset.length} legal contracts`)
console.log(`📝 Training examples: ${fineTuningData.length}`)
...
- Cost: $72 (18 hours × $4/hour on cloud GPU)
...
const modelComparison = [
  ...
  { model: 'Llama 3 70B', accuracy: 93%, cost_per_contract: 0.72 },  // Sweet spot ✅
...
const datasetScaling = [
  ...
  { examples: 10_000, accuracy: 93%, overfitting_risk: 'low' },    // ✅ Sweet spot
...
- r=8: 91% accuracy
- r=16: 93% accuracy (worth 2× memory overhead)
...
| **Fine-Tuned Open-Source (QLoRA)** | $3,600 | 93% | 3.8s | High volume (5,000+/month) ✅ |
...
- **Throughput**: 5,000 contracts/month → 15,000/month (3x capacity with same budget)
