...
- Deploy → discover it fails on 30% of real queries
...
async function evaluateGoldenDataset(
  ...
  console.log(`🧪 Evaluating system against ${dataset.length} golden queries...\n`)
...
async function saveToLeaderboard(
  ...
  console.log(`✅ Saved to leaderboard: ${leaderboardEntry.runId}`)
}
