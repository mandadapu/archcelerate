...
export default async function ProjectPage({ params }: Props) {
  ...
  async function submitProject(formData: FormData) {
    ...
    redirect(`/curriculum/week-1/project/${params.slug}`)
  }
          ...
          <form action={submitProject} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Write a comparison between your visual builder implementation and code implementation.
                What were the tradeoffs? What did you learn?
              </p>
              <Textarea
                id="writeupContent"
                name="writeupContent"
                placeholder="Describe your experience building with both visual tools and code..."
                rows={10}
