...
export default async function Week6Page() {
  ...
  if (!week) {
    return <div className="container max-w-4xl py-8">Week 11 not found</div>
  }
  ...
  return (
    <div className="container max-w-4xl py-8">
      <div className="space-y-8">
        {/* Header */}
        <div>
          <div className="text-sm text-muted-foreground mb-2">Week 11</div>
        ...
        <div>
          ...
          <div className="grid gap-4">
            {concepts.map((concept, i) => (
              <Link
                key={concept.id}
                href={`/curriculum/week-11/concepts/${concept.slug}`}
        ...
        {lab && (
          <div>
            ...
            <Link
              href={`/curriculum/week-11/lab/${lab.slug}`}
        ...
        {project && (
          <div>
            ...
            <Link
              href={`/curriculum/week-11/project/${project.slug}`}
