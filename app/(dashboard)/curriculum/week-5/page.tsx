...
export const metadata: Metadata = {
  title: 'Week 5: AI Agents + Agent Pattern Library (Part 1)',
  description: 'Master agent architectures, tool calling, and build 3 agent patterns'
}
          ...
          <div className="grid gap-4">
            {concepts.map((concept, i) => (
              <Link
                ...
                className="border rounded-lg p-4 hover:border-indigo-600 transition-colors bg-indigo-50/50 dark:bg-indigo-950/50"
              >
