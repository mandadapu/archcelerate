...
export default async function Week9Page() {
  ...
  const data = await getWeekData(9, session.user.email)
  if (!data) {
    return <div className="container max-w-4xl py-8">Week 9 not found</div>
  }
    ...
    <div className="container max-w-4xl py-8">
      <div className="space-y-8">
        ...
        <div className="flex items-center gap-2 text-sm text-muted-foreground">
          ...
          <span>/</span>
          <span className="text-foreground">Week 9</span>
        </div>
