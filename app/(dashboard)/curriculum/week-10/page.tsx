...
export const metadata: Metadata = {
  title: 'Week 10: Observability + Production',
  ...
  return (
    <div className="container max-w-4xl py-8">
      <div className="space-y-8">
        {/* Header */}
        <div>
          <div className="text-sm text-muted-foreground mb-2">Week 10</div>
        ...
        <div>
          ...
          <div className="grid gap-4">
            {concepts.map((concept, i) => (
              <Link
                key={concept.id}
                href={`/curriculum/week-10/concepts/${concept.slug}`}
        ...
        {lab && (
          <div>
            ...
            <Link
              href={`/curriculum/week-10/lab/${lab.slug}`}
        ...
        {project && (
          <div>
            ...
            <Link
              href={`/curriculum/week-10/project/${project.slug}`}
