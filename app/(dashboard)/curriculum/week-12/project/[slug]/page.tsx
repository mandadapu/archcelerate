...
export default async function ProjectPage({ params }: Props) {
  ...
  async function submitProject(formData: FormData) {
    ...
    redirect(`/curriculum/week-12/project/${params.slug}`)
  }
  ...
  return (
    <div className="container max-w-4xl py-8">
      ...
      <div className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
        <Link href="/curriculum/week-12" className="hover:text-foreground">
          Week 12
        </Link>
        <span>/</span>
        <span>Project</span>
      ...
      {isSubmitted && (
        <Card className="mt-8 bg-gradient-to-br from-green-50 to-blue-50 dark:from-green-950 dark:to-blue-950 border-green-200">
          <CardHeader>
            ...
            <CardDescription>
              Congratulations! You&apos;ve completed Week 12 - Observability + Production. You&apos;ve successfully deployed a production-ready AI application with monitoring, caching, and reliability features!
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Link href="/dashboard">
