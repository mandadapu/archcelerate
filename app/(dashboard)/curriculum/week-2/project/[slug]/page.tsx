...
export default async function ProjectPage({ params }: Props) {
  ...
  async function submitProject(formData: FormData) {
    ...
    redirect(`/curriculum/week-2/project/${params.slug}`)
  }
      ...
      {isSubmitted && (
        <Card className="mt-8 bg-gradient-to-br from-green-50 to-blue-50 dark:from-green-950 dark:to-blue-950 border-green-200">
          <CardHeader>
            ...
            <CardDescription>
              Congratulations! You&apos;ve completed Week 2 - Chat + Governance. You&apos;ve successfully deployed a production-ready AI application with monitoring, caching, and reliability features!
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Link href="/dashboard">
